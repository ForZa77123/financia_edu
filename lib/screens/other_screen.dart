...
class _OtherScreenState extends State<OtherScreen> {
  ...
  Future<void> _editProfile() async {
    ...
    final TextEditingController usernameController = TextEditingController(text: oldUsername);
                ...
                child: Column(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: CircleAvatar(
                        radius: 36,
                        backgroundImage: newProfileImage != null ? FileImage(File(newProfileImage!)) : null,
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (newUsername != oldUsername && usersBox.containsKey(newUsername)) {
                    ...
                    if (newUsername != oldUsername) {
                      ...
                      final oldRecords = recordsBox.get(oldUsername, defaultValue: <Map>[]) as List;
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    IconButton(
                      onPressed: _editProfile, // Sudah benar, icon edit memanggil fungsi edit profile
              ...
              ListView(
                ...
                children: [
                        ...
                        builder: (context) => SimpleDialog(
                          ...
                          children: [
                            RadioListTile<ThemeMode>(
                              ...
                              groupValue: widget.themeMode ?? ThemeMode.light,
                  ...
                  ListTile(
                    ...
                    subtitle: widget.selectedDate != null && widget.budget != null
                        ? Text(
                            "Budget bulan ${widget.selectedDate!.month}/${widget.selectedDate!.year}: Rp ${widget.budget!.toStringAsFixed(0)}",
                            style: const TextStyle(fontSize: 13),
                          )
                        : const Text("Belum diatur", style: TextStyle(fontSize: 13)),
                    trailing: Icon(Icons.chevron_right, color: colorScheme.primary),
